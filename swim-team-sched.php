  ...
  <table id="MeetSchedule" width="90%" border="1" align="center" class="display">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>HOME</td>
        <td></td>
        <td class="nobr"><a href="docs/swim-team-results/2014-07-07-LS-improvement.pdf">Improvements</a></td>
        <td>-</td>
      </tr>
      <tr>
        <td>July 9</td>
      ...
      <tr>
        ...
        <td>Ilda</td>
        <td>HOME</td>
        <td><?php if(strtotime("2014-07-12") - time() > 0) { ?><a href="http://www.signupgenius.com/go/10c0c44a8a62aa57-ilda1">Volunteer</a><?php } ?></td>
        <td class="nobr">-</td>
        <td>-</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>VA Hills</td>
        <td>HOME</td>
        <td><?php if(strtotime("2014-07-14") - time() > 0) { ?><a href="http://www.signupgenius.com/go/10c0c44a8a62aa57-divisionals">Volunteer</a><?php } ?></td>
        <td class="nobr">-</td>
        <td>-</td>
      </tr>
      <tr>
